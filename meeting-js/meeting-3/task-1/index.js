...
const bigNumbers = anotherNumbersList.filter(function(num) {
    return num > 5;
});

const bigNumbers = anotherNumbersList.filter(num => num > 5);
...
const anotherNumbersList.map(item => item * item);
